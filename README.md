...
|:---|:---|:---|:---|
|<span style="white-space: nowrap;"> **ADR-01** </span>| **Микросервисная архитектура (DDD)** | Необходимость независимого масштабирования доменов (Бронирование vs Аналитика) и работа разных команд над модулями. | ✅ Принято |
