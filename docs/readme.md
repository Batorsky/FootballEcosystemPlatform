...
9. Для каждой пары участников организатор бронирует в **Booking Service** спортивную площадку под каждый матч;
...
12. По завершении матчей организатор вносит счет; **Tournament Service** автоматически обновляет сетку;
13. Система через **Kafka** и **Notification Service** уведомляет следующих участников о времени и месте их матча.
