...
Альтернативный поток (Командная бронь):
   ...
   * **Booking Service** отправляет событие в **Kafka**
   * **Notification Service** рассылает push-уведомления игрокам команды.

3. **UC-2: Персонализированное предложение и покупка.**
...
4. **UC-3: Проведение крупного турнира.**
