...
Предметом проектирования является концептуальная архитектура, описывающая мобильное приложение, построенное микросервисной архитектуре с использованием методологии DDD и обладающее высоким потенциалом для горизонтального масштабирования. Приложение проектируется как некий фундамент, позволяющий расширять географию сервиса (от локального MVP до глобального рынка) и наращивать функциональсть без перепроектирования ядра.  
